...
import (
	...
	"github.com/fiorri/fabric-sdk-go/pkg/core/logging/metadata"
)
...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "github.com/fiorri/fabric-sdk-go/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "github.com/fiorri/fabric-sdk-go/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "github.com/fiorri/fabric-sdk-go/internal_/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
