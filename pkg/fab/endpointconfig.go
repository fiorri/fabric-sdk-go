...
import (
	...
	commtls "github.com/fiorri/fabric-sdk-go/pkg/core/config/comm/tls"
	"github.com/fiorri/fabric-sdk-go/pkg/core/config/cryptoutil"
	...
	"github.com/fiorri/fabric-sdk-go/pkg/util/pathvar"
...
func detectDeprecatedNetworkConfig(endpointConfig *EndpointConfig) {
	...
	for _, v := range endpointConfig.networkConfig.Channels {
		if len(v.Orderers) > 0 {
			...
			logger.Warn("visit https://github.com/fiorri/fabric-sdk-go/blob/master/test/fixtures/config/overrides/local_entity_matchers.yaml for samples")
			break
		}
	}
}
