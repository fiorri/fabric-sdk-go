...
import (
	...
	factory "github.com/fiorri/fabric-sdk-go/internal_/github.com/hyperledger/fabric/sdkpatch/cryptosuitebridge"
...
type bccspmsp struct {
	...
	// are boolean. True means that the certificate is an internal_ node of the certification tree.
...
// Setup sets up the internal_ data structures
