...
[![Release](https://img.shields.io/github/release/hyperledger/fabric-sdk-go.svg?style=flat-square)](https://github.com/fiorri/fabric-sdk-go/releases/latest)
...
[![GoDoc](https://godoc.org/github.com/fiorri/fabric-sdk-go?status.svg)](https://godoc.org/github.com/fiorri/fabric-sdk-go)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/fiorri/fabric-sdk-go)](https://goreportcard.com/report/github.com/fiorri/fabric-sdk-go)
...
```bash
go get github.com/fiorri/fabric-sdk-go
```
...
SDK documentation can be viewed at [GoDoc](https://godoc.org/github.com/fiorri/fabric-sdk-go).
...
```bash
git clone https://github.com/fiorri/fabric-sdk-go.git
```
